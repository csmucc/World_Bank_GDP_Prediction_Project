...
- [`Worldbank.ipynb`](Worldbank.ipynb) — Jupyter Notebook with data cleaning, analysis, and modeling  
- [`c538bed6-24d9-4d25-a075-11dc22bfe385_Data.csv`](c538bed6-24d9-4d25-a075-11dc22bfe385_Data.csv) — Cleaned dataset ready for exploration and modeling  
...
- World Bank Databank for providing the data  
- StackOverflow and Kaggle for community guidance and examples
